...
Una de las formas más utilizadas para calcular valores atípicos es

**El promedio ± n \* desviación estándar**

-   Para este caso n sera igual a 3

    <https://help.highbond.com/helpdocs/analytics/141/user-guide/es/Content/analyzing_data/identifying_outliers.htm>
    ...
    A partir de los limites obtenidos se pueden apreciar los valores atípicos
